...
const messages: Record<keyof Messages, string> = {
	...
	'enum.activitySubtype.poop': 'Cocô',
	'enum.activitySubtype.leash': 'Na guia',
	'enum.activitySubtype.offleash': 'Solto',
	'enum.activitySubtype.hike': 'Trilha',
	'enum.activitySubtype.breakfast': 'Café da manhã',
	'enum.activitySubtype.lunch': 'Almoço',
	'enum.activitySubtype.dinner': 'Jantar',
	'enum.activitySubtype.snack': 'Lanche',
	'enum.activitySubtype.fetch': 'Buscar',
	'enum.activitySubtype.tug': 'Cabo de guerra',
	'enum.activitySubtype.puzzle': 'Quebra-cabeça',
	'enum.activitySubtype.social': 'Com amigos',
	'enum.activitySubtype.bath': 'Banho',
	'enum.activitySubtype.brush': 'Escovação',
	'enum.activitySubtype.trim': 'Tosa',
	'enum.activitySubtype.nails': 'Unhas',
	'enum.activitySubtype.teeth': 'Dentes',
	'enum.activitySubtype.ears': 'Orelhas',
	'enum.activitySubtype.chew': 'Mordedor',
	'enum.activitySubtype.dental': 'Dental',
	'enum.activitySubtype.training': 'Adestramento',
	...
	'error.invalidSubtype': 'Subtipo inválido para esta atividade',
...
'overview.heading.companions': 'Os seus companheiros',
	...
	'overview.quickLog.title': 'Registo rápido',
	...
	'page.log.subtypeLabel': 'Qual tipo?',
	...
	'page.log.selectCompanions': 'Registar para',
	'page.log.selectAtLeastOne': 'Seleciona pelo menos um companheiro.',
	'page.companion.sectionQuickLog': 'Registo rápido',
	'page.companion.logActivity': 'Registar atividade',

	// Custom quick logs & API tokens (issue #173)
	'quickLogs.title': 'Registos rápidos',
	'quickLogs.subtitle': 'Cria botões de um toque para eventos repetitivos.',
	'quickLogs.manage': 'Gerir',
	'quickLogs.settingsLinkDescription':
		'Cria e partilha botões de um toque para eventos repetitivos.',
	'quickLogs.nameLabel': 'Nome do botão',
	'quickLogs.namePlaceholder': 'p. ex. Passeio noturno',
	'quickLogs.typeLabel': 'Atividade',
	'quickLogs.noteLabel': 'Nota',
	'quickLogs.notePlaceholder': 'Adicionada a cada entrada registada por este botão',
	'quickLogs.companionsLabel': 'Companheiros',
	...
	'settings.apiTokens.description':
		'Cria tokens para que botões inteligentes, scripts e outros dispositivos registem eventos através da API. Envia-os como cabeçalho Authorization: Bearer.',
	...
	'page.admin.apiAccessOffHint':
		'O acesso à API está revogado; todos os tokens deste utilizador estão inativos.',
	'page.admin.apiAccessRevoke': 'Revogar acesso à API',
	'page.admin.apiAccessGrant': 'Conceder acesso à API',
	'email.apiAccess.grantedSubject': 'O teu acesso à API do EinVault foi concedido',
	'email.apiAccess.grantedBody':
		'Um administrador concedeu à tua conta acesso à API do EinVault. Já podes criar tokens de API nas Definições.',
	'email.apiAccess.revokedSubject': 'O teu acesso à API do EinVault foi revogado',
	'email.apiAccess.revokedBody':
		'Um administrador revogou o acesso da tua conta à API do EinVault. Os teus tokens de API deixarão de funcionar até o acesso ser concedido novamente.',
	'error.invalidRequestBody': 'Corpo do pedido inválido.',
	'error.noCompanionsSelected': 'Seleciona pelo menos um companheiro.',
	...
	'error.journalTooLong': 'A entrada do diário é demasiado longa (máx. {max} caracteres).',
	'error.invalidMood': 'O humor deve ser um dos seguintes: great, good, meh, off, sick.',
