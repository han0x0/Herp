...
const messages: Record<keyof Messages, string> = {
	...
	'enum.activitySubtype.leash': 'En laisse',
	'enum.activitySubtype.offleash': 'Sans laisse',
	'enum.activitySubtype.hike': 'Randonnée',
	'enum.activitySubtype.breakfast': 'Petit-déjeuner',
	'enum.activitySubtype.lunch': 'Déjeuner',
	'enum.activitySubtype.dinner': 'Dîner',
	'enum.activitySubtype.snack': 'Collation',
	'enum.activitySubtype.fetch': 'Rapporter',
	'enum.activitySubtype.tug': 'Tir à la corde',
	'enum.activitySubtype.puzzle': 'Casse-tête',
	'enum.activitySubtype.social': 'Entre amis',
	'enum.activitySubtype.bath': 'Bain',
	'enum.activitySubtype.brush': 'Brossage',
	'enum.activitySubtype.trim': 'Coupe',
	'enum.activitySubtype.nails': 'Griffes',
	'enum.activitySubtype.teeth': 'Dents',
	'enum.activitySubtype.ears': 'Oreilles',
	'enum.activitySubtype.chew': 'À mâcher',
	'enum.activitySubtype.dental': 'Dentaire',
	'enum.activitySubtype.training': 'Dressage',
	...
	'error.invalidSubtype': 'Sous-type invalide pour cette activité',
	...
	'page.settings.profilePhoto': 'Photo de profil',
	'page.settings.changePhoto': 'Changer la photo',
	'page.settings.removePhoto': 'Supprimer',
	'page.settings.photoUpdated': 'Photo de profil mise à jour.',
	...
	'page.settings.appearanceCard': 'Apparence',
	...
	// Page: companion edit
	'page.companion.edit.backToCompanions': 'Retour aux compagnons',
	...
	'overview.greeting': 'Bonjour, {name}',
	'overview.needsAttention': 'Nécessite attention',
	'overview.allCaughtUp': 'Tout est à jour',
	...
	'overview.careStatus.upToDate': 'À jour',
	'overview.careStatus.dueToday': "Prévu aujourd'hui",
	'overview.careStatus.needsAttention': 'Nécessite attention',
	'overview.journal.noEntryYet': "Pas d'entrée de journal aujourd'hui",
	'overview.journal.addTodayShort': "+ Ajouter aujourd'hui",
	'overview.reminders.none': 'Aucun rappel',
	'overview.recentHousehold': 'Activité récente du foyer',
	...
	'page.dashboard.cardUpcomingReminders': 'Rappels à venir',
	'page.dashboard.cardRecentActivity': 'Activité récente',
	'page.dashboard.cardWeightTrend': 'Tendance du poids',
	'page.dashboard.weightTrendViewHealth': 'Voir la santé',
	'page.dashboard.weightTrendEmpty': 'Aucun poids enregistré.',
	'page.dashboard.nextVet': 'Prochain vétérinaire',
	'page.dashboard.noUpcomingReminders': 'Aucun rappel à venir.',
	'page.dashboard.heroRecentActivity': '{count} activités',
	'page.dashboard.reminderOverdue': 'En retard',
	'page.dashboard.reminderToday': "Aujourd'hui",
	...
	'page.log.subtypeLabel': 'Quel type ?',
	...
	'quickLogs.title': 'Saisies rapides',
	'quickLogs.subtitle': 'Créez des boutons à une touche pour les événements répétitifs.',
	'quickLogs.manage': 'Gérer',
	'quickLogs.settingsLinkDescription':
		'Créez et partagez des boutons à une touche pour les événements répétitifs.',
	'quickLogs.nameLabel': 'Nom du bouton',
	'quickLogs.namePlaceholder': 'p. ex. Promenade du soir',
	'quickLogs.typeLabel': 'Activité',
	'quickLogs.noteLabel': 'Note',
	'quickLogs.notePlaceholder': 'Ajoutée à chaque entrée enregistrée par ce bouton',
	'quickLogs.companionsLabel': 'Compagnons',
	...
	'settings.apiTokens.description':
		'Créez des jetons pour que boutons connectés, scripts et autres appareils enregistrent des événements via l’API. Envoyez-les dans un en-tête Authorization: Bearer.',
	...
	'page.admin.apiAccessOffHint':
		'L’accès à l’API est révoqué ; tous les jetons de cet utilisateur sont inactifs.',
	'page.admin.apiAccessRevoke': 'Révoquer l’accès à l’API',
	'page.admin.apiAccessGrant': 'Accorder l’accès à l’API',
	'email.apiAccess.grantedSubject': 'Votre accès à l’API EinVault a été accordé',
	'email.apiAccess.grantedBody':
		'Un administrateur a accordé à votre compte l’accès à l’API EinVault. Vous pouvez désormais créer des jetons d’API dans les Réglages.',
	'email.apiAccess.revokedSubject': 'Votre accès à l’API EinVault a été révoqué',
	'email.apiAccess.revokedBody':
		'Un administrateur a révoqué l’accès de votre compte à l’API EinVault. Vos jetons d’API cesseront de fonctionner tant que l’accès n’est pas rétabli.',
	'error.invalidRequestBody': 'Corps de requête invalide.',
	'error.noCompanionsSelected': 'Sélectionnez au moins un compagnon.',
	...
	'error.noValidTargets':
		'Cette saisie rapide n’a aucun compagnon pour lequel vous pouvez enregistrer pour le moment.',
	...
	'error.invalidOccurredAt':
		'occurredAt doit être une date-heure ISO 8601 valide dans la plage autorisée.',
	'error.invalidWeight': 'Le poids doit être un nombre positif.',
	'error.invalidUnit': 'L’unité doit être kg ou lbs.',
	'error.invalidRecordedAt':
		'recordedAt doit être une date-heure ISO 8601 valide dans la plage autorisée.',
	'error.invalidPagination':
		'limit doit être compris entre 1 et 200 et offset doit être 0 ou plus.',
