...
const messages: Record<keyof Messages, string> = {
	...
	'common.updatedBy': 'bearbeitet von {name}',
	...
	'enum.activitySubtype.poop': 'Häufchen',
	'enum.activitySubtype.leash': 'An der Leine',
	'enum.activitySubtype.offleash': 'Ohne Leine',
	'enum.activitySubtype.hike': 'Wanderung',
	'enum.activitySubtype.breakfast': 'Frühstück',
	'enum.activitySubtype.lunch': 'Mittagessen',
	'enum.activitySubtype.dinner': 'Abendessen',
	'enum.activitySubtype.snack': 'Snack',
	'enum.activitySubtype.fetch': 'Apportieren',
	'enum.activitySubtype.tug': 'Zerrspiel',
	'enum.activitySubtype.puzzle': 'Denkspiel',
	'enum.activitySubtype.social': 'Mit Freunden',
	'enum.activitySubtype.bath': 'Bad',
	'enum.activitySubtype.brush': 'Bürsten',
	'enum.activitySubtype.trim': 'Schneiden',
	'enum.activitySubtype.nails': 'Krallen',
	'enum.activitySubtype.teeth': 'Zähne',
	'enum.activitySubtype.ears': 'Ohren',
...
'overview.heading.companions': 'Deine Begleiter',
	...
	'overview.quickLog.title': 'Schnell erfassen',
	...
	'page.log.subtypeLabel': 'Welche Art?',
	...
	'page.log.selectCompanions': 'Erfassen für',
	'page.log.selectAtLeastOne': 'Wähle mindestens einen Begleiter aus.',
	'page.companion.sectionQuickLog': 'Schnell erfassen',
	'page.companion.logActivity': 'Aktivität erfassen',

	// Custom quick logs & API tokens (issue #173)
	'quickLogs.title': 'Schnell-Logs',
	'quickLogs.subtitle': 'Erstelle Ein-Tipp-Buttons für wiederkehrende Ereignisse.',
	'quickLogs.manage': 'Verwalten',
	'quickLogs.settingsLinkDescription':
		'Erstelle und teile Ein-Tipp-Buttons für wiederkehrende Ereignisse.',
	'quickLogs.nameLabel': 'Button-Name',
	'quickLogs.namePlaceholder': 'z. B. Abendspaziergang',
	'quickLogs.typeLabel': 'Aktivität',
	'quickLogs.noteLabel': 'Notiz',
	'quickLogs.notePlaceholder': 'Wird jedem Eintrag dieses Buttons hinzugefügt',
	'quickLogs.companionsLabel': 'Begleiter',
	'quickLogs.enabledLabel': 'Aktiviert',
	'quickLogs.empty': 'Noch keine Schnell-Logs',
	'quickLogs.emptyBody':
		'Erstelle einen Button für ein wiederkehrendes Ereignis, z. B. den Abendspaziergang, und erfasse es mit einem Tipp.',
	'quickLogs.addButton': 'Schnell-Log hinzufügen',
	'quickLogs.disabledBadge': 'Deaktiviert',
	...
	'quickLogs.delete': 'Löschen',
	'quickLogs.share': 'Teilen',
	'quickLogs.shareTitle': 'Kopie teilen',
	'quickLogs.shareHint':
		'Empfänger erhalten eine eigene, unabhängige Kopie. Spätere Änderungen hier wirken sich nicht auf sie aus.',
	'quickLogs.shareButton': 'Kopie teilen',
	...
	'settings.apiTokens.description':
		'Erstelle Tokens, mit denen smarte Buttons, Skripte und andere Geräte Ereignisse über die API erfassen. Sende sie als Authorization: Bearer-Header.',
	...
	'settings.apiTokens.created': 'Erstellt',
	...
	'page.admin.apiAccessOffHint':
		'API-Zugriff ist entzogen; alle Tokens dieses Benutzers sind inaktiv.',
	'page.admin.apiAccessRevoke': 'API-Zugriff entziehen',
	'page.admin.apiAccessGrant': 'API-Zugriff gewähren',
	'email.apiAccess.grantedSubject': 'Dein EinVault-API-Zugriff wurde gewährt',
	'email.apiAccess.grantedBody':
		'Ein Administrator hat deinem Konto Zugriff auf die EinVault-API gewährt. Du kannst jetzt API-Tokens in den Einstellungen erstellen.',
	'email.apiAccess.revokedSubject': 'Dein EinVault-API-Zugriff wurde entzogen',
	'email.apiAccess.revokedBody':
		'Ein Administrator hat deinem Konto den Zugriff auf die EinVault-API entzogen. Deine API-Tokens funktionieren erst wieder, wenn der Zugriff erneut gewährt wird.',
	'error.invalidRequestBody': 'Ungültiger Anfrageinhalt.',
	'error.noCompanionsSelected': 'Wähle mindestens einen Begleiter aus.',
	...
	'error.journalTooLong': 'Tagebucheintrag ist zu lang (max. {max} Zeichen).',
	'error.invalidMood': 'Stimmung muss einer der folgenden Werte sein: great, good, meh, off, sick.',
